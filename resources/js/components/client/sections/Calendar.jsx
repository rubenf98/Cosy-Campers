...
function CalendarContainer({ text }) {
    ...
    return (
        <Container>
            ...
            <DatePicker
                ...
                mapDays={({ date }) => {
                    let isDisabled = ["2023/06/01"].includes(date.format('YYYY/MM/DD'))
                ...
                renderButton={(direction, handleClick, disabled) => (
                    ...
                    }} className={direction === "right" ? "rmdp-right" : "rmdp-left"} onClick={handleClick}>
                        {direction === "right" ? ">" : "<"}
                    </Arrow>
                )}
            />
